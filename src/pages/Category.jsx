...
export default function Category() {
  const { id } = useParams();
  const filteredProducts = products.filter(product => product.CATEGORY_ID == id.toUpperCase());
  return (
    <div className="flex w-full flex-col items-center justify-center bg-[#e0f2fe] p-4">
      <div className="flex flex-col w-full max-w-[1200px] min-h-screen bg-white rounded-2xl shadow-lg p-6">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 mt-2">Khám phá những sản phẩm tốt nhất trong danh mục này</p>
        </div>
