...
const CartPage = () => {
  ...
  if (loading) {
    ...
    cartContent = <p className="text-center text-gray-500">Giỏ hàng trống.</p>;
  } else {
    cartContent = (
      <>
        ...
        <div className="flex justify-between items-center pt-6">
          <a
            className="px-6 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-800"
            href="/product"
          >
            Tiếp tục mua hàng
          </a>
          <button
            ...
            className="px-6 py-2 rounded bg-sky-600 hover:bg-sky-700 text-white font-semibold shadow"
          >
            Thanh toán
          </button>
        </div>
