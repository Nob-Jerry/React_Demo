export default function Footer() {
    ...
    <footer className="bg-blue-50 text-blue-900">
        <div className="container flex flex-col p-6 mx-auto md:p-10 lg:flex-row border-t-4 border-blue-300">
            ...
            <li className="hover:text-blue-700 cursor-pointer transition">Cửa hàng</li>
            <li className="hover:text-blue-700 cursor-pointer transition">Thông tin</li>
            <li className="hover:text-blue-700 cursor-pointer transition">Blog</li>
            <li className="hover:text-blue-700 cursor-pointer transition">Liên hệ</li>
            </ul>
